...
//   const demoLogins = [
//     { role: 'Admin', email: 'adit@gmail.com', password: '123456' },
//     { role: 'Accountant', email: 'demo_accountant@gmail.com', password: '123456' },
//     { role: 'Mess Incharge', email: 'maisam@gmail.com', password: '123456' },
//     { role: 'Security', email: 'demo_security@gmail.com', password: '123456' },
//   ];
...
const Login = () => {
  ...
  // Now it ONLY fills the form, does NOT auto-login
  const handleDemoLogin = (demoUser) => {
    setValues({ email: demoUser.email, password: demoUser.password });
  };
