...
// Icons
import {
  FaUtensils, FaPlus, FaCheckCircle, FaBan, FaExclamationTriangle,
  FaEdit, FaTrash, FaSun, FaCloudSun, FaMoon, FaCookieBite,
  FaUser, FaIdCard, FaMoneyBillWave, FaStickyNote, FaToggleOn,
  FaCheck, FaUndo, FaSpinner, FaTimes, FaFilter
} from 'react-icons/fa';
...
const FoodOrders = () => {
  ...
  const getCategoryIcon = (category) => {
    switch (category) {
      case 'BREAKFAST': return <FaSun className="me-1" />;
      case 'LUNCH': return <FaCloudSun className="me-1" />;
      case 'DINNER': return <FaMoon className="me-1" />;
      case 'SNACK': return <FaCookieBite className="me-1" />;
      default: return <FaUtensils className="me-1" />;
    }
  };
  ...
  return (
    <Layout>
      <Container fluid>
        <Row className="mb-4">
          <Col>
            <h2 className="text-orange"><FaUtensils className="me-2" /> Food Orders</h2>
            <p className="text-muted">Manage food orders and billing</p>
          </Col>
          <Col className="text-end">
            <Button
        ...
        {/* Success Alert (kept as dismissible alert) */}
        {success && (
          <Alert variant="success" onClose={() => setSuccess('')} dismissible>
            <div className="d-flex align-items-center">
                      ...
                      {(!orders || orders.length === 0) ? (
                        ...
                        orders.map(order => (
                          <tr key={order._id}>
                            ...
                            <td>
                              <Badge bg={getStatusBadge(order.isBilled)}>
                                {order.isBilled ? <FaCheckCircle className="me-1" /> : <FaBan className="me-1" />}
                                {order.isBilled ? 'Billed' : 'Pending'}
                              </Badge>
                            </td>
                            <td>
                            ...
                            <td>
                              <small><FaUser className="me-1" size={10} /> {getOrderedByName(order.orderedBy)}</small>
                            </td>
                            <td>
                              <Dropdown>
                                <Dropdown.Toggle variant="light" size="sm">
                                ...
                                <Dropdown.Menu>
                                  {!order.isBilled ? (
                                    ...
                                    >
                                      <FaCheck className="me-2 text-success" /> Mark as Billed
                                    </Dropdown.Item>
                                  ) : (
                                    <Dropdown.Item 
                                      onClick={() => {
                                      ...
                                      className="d-flex align-items-center"
                                    >
                                      <FaUndo className="me-2 text-warning" /> Mark as Unbilled
                                    </Dropdown.Item>
                                  )}
                                </Dropdown.Menu>
                              </Dropdown>
                ...
                <Card className="bg-light">
                  <Card.Body className="py-2">
                    <Row>
                      ...
                      <Col className="text-end">
                        <div className="fw-bold text-success">
                          <FaMoneyBillWave className="me-1" /> Total: ₹{calculateCurrentOrderTotal()}
                        </div>
                      </Col>
                    </Row>
                  </Card.Body>
